    ...
    def filters = {
        all(uri: "/**") {
            before = {
                ...
                def allowedActions = ['frob','slideshow','view', 'index', 'src', 'thumbnail', 'home', 'requestPermission', 'requestRoles', 'error', 'info','list','all','query','send','calendar','events','event','current','future','regular','displayAll','display']
