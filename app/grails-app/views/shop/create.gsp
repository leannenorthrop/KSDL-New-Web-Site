...
<html>
  <head>
    ...
    <title><g:message code="product.create.title"/></title>
    <g:javascript src="jquery/jquery.form.js"/>    
  </head>
  <body>
    <g:form name="addproduct" action="save" method="post">
        ...
        <g:submitButton name="update" class="ui-corner-all" value="${message(code: 'product.add.btn', default: 'Add Product')}"/>
    </g:form>
  </body>
</html>
