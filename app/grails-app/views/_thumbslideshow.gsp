...
<g:javascript>
  ...
  var myShow = new Slideshow('show', data, {href:"${relUrl}", controller: true, captions: false, titles: true, height: 100, thumbnails: false, width: 100, overlap: false, delay:2500});
</g:javascript>
</g:if>
