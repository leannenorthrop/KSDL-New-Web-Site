      ...
      <g:each in="${articles}" status="i" var="articleInstance">
        <li class="article group">
          ...
          <g:if test="${articleInstance.image}">
            <img src="${createLink(controller: 'image', action: 'thumbnail', id: articleInstance.image.id)}" title="${articleInstance.image.name}" alt="${articleInstance.image.name}" style="float:left;"/>
          </g:if>
