...
<body>
    <div class="jquery-ui content passwordReset">
        <g:form id="resetpasswordform" name="resetpasswordform" action="onResetPassword" class="ui-widget ui-corner-all">
            ...
            <a class="submit" onClick="document.resetpasswordform.submit();" id="resetPassword">Reset Password &raquo;</a>
          </g:form>
      </div>
</body>
</html>
